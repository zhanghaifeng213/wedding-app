<template>
    <div class="message">
        <view class="box">
            <p class="place"></p>
            <div class="item" v-for="(item, index) in messageList" :key="index" v-if="flag">
            ...
            <div v-if="!flag" style="text-align:center">百年好合</div>

            <!-- loading -->
            <view class="load-more" v-if="flag">
        ...
        <div class="video-dialog" @tap="toVideo" v-if="flag">
            <image src="../../static/images/video1.png"/>
        </div>
        <div class="form-dialog" @tap="lookList" v-if="flag">
            <image src="../../static/images/form.png"/>
        </div>
        <div class="video" v-show="isVideo">
            <h-video v-if="isVideo" @closeVideo="closeVideo"></h-video>
        </div>
